/*
  ...
  - You are about to drop the column `deletedsAt` on the `user` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "specialties" ALTER COLUMN "icon" SET DATA TYPE VARCHAR(255);

-- AlterTable
ALTER TABLE "user" DROP COLUMN "deletedsAt",
...
-- RenameIndex
ALTER INDEX "Idx_doctor_isDeleted" RENAME TO "idx_doctor_isDeleted";

-- RenameIndex
ALTER INDEX "idx_specilty_isDeleted" RENAME TO "idx_specialty_isDeleted";

-- RenameIndex
ALTER INDEX "idx_specilty_title" RENAME TO "idx_specialty_title";
